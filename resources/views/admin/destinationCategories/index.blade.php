...
<div class="card bootstrap-table">
    <div class="card-body table-full-width">
      <div class="toolbar">
        <a href="{{ route('admin.destinationCategory.importExport') }}" class="m1-1">
          <button class="btn btn-outline" style="border-radius: 30px">
            <i class="glyphicon fa fa-upload"></i>
          </button>
        </a>
      </div>
      <table id="bootstrap-table" class="table" data-url="{{ route('admin.destinationCategories.index') }}">
        <thead>
          <th data-field="id" class="text-center" data-sortable="true">ID</th>
          <th data-field="category_id">Category Name</th>
